      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600">
          ...
          <ul>
            ...
            <li>Stretch Mark Camouflage: This treatment uses custom-blended pigments to reduce the appearance of stretch marks, whether they’re new or old. By restoring your skin’s natural tone and texture, we help stretch marks blend in, leaving your skin looking smoother and more even.</li>
